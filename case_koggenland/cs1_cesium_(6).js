...
// Add the parcels from the municipality of Koggenland
      const parcelTileset = scene.primitives.add(
        new Cesium.Cesium3DTileset({
          url: Cesium.IonResource.fromAssetId(1119899),
        })
      );
...
Sandcastle.addDefaultToolbarButton("Overview", function () {  
  viewer.camera.flyTo({
  destination: Cesium.Cartesian3.fromDegrees(4.925948, 52.656960, 500.0)
});
});

Sandcastle.addDefaultToolbarButton("Rainwater drainage pipe segment", function () {
