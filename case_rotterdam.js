...
// Add Cesium OSM Buildings for reference
...
// Add the parcels from Rotterdam
      const parcelTileset = scene.primitives.add(
        new Cesium.Cesium3DTileset({
          url: Cesium.IonResource.fromAssetId(1114196),
        })
      );
...
Sandcastle.addDefaultToolbarButton("Overview", function () {  
  viewer.camera.flyTo({
  destination: Cesium.Cartesian3.fromDegrees(4.478362, 51.917606, 800.0)
});
});

Sandcastle.addDefaultToolbarButton("Telecom cable segment", function () {
